...
D. Update and review `README.rst` and `Sphinx` docs, then check viz/docs/build/html/index.html
...
H. Increment the version number in `viz/__init__.py`
...
T. Release on GitHub: https://github.com/donnemartin/viz/tags
