...
| | Repo | Stars |
|---|---|---|
| 1. | [JuliaDiffEq/DifferentialEquations.jl](https://github.com/JuliaDiffEq/DifferentialEquations.jl) <br/>Julia suite for high-performance solvers of differ... | 137 |
...
| | Org | Repos | Stars |
|---|---|---|---|
| 1. | [JuliaDiffEq](https://github.com/JuliaDiffEq)  | [DifferentialEquations.jl](https://github.com/JuliaDiffEq/DifferentialEquations.jl)  (137) <br/> | 137 |
